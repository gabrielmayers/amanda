...
<ul>
 <li> Go to [Twitter Developers](https://developer.twitter.com/en/dashboard) </li>
 <li> Get your API Key </li>
 <li>Clone this repo and pip install the requirements </li>
 <li> Put your API Key into [auth file](https://github.com/gabrielmayers/amanda/blob/master/auth.py)
 <li> Run it by using <pre> python main.py </pre>
</ul>
